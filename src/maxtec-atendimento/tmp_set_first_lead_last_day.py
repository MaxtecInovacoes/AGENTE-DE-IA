...
proxima=(now - timedelta(days=1, minutes=2)).isoformat(timespec='seconds')
created=(now - timedelta(days=1, minutes=10)).isoformat(timespec='seconds')
...
print('set first lead due at', proxima)
